> **Archived.** This is the original, long-form README — a build log plus an
> exhaustive command/gotcha reference kept from the project's development.
> It is preserved for detail, not as the starting point. Read the
> [current README](../README.md) first; see also [`ARCHITECTURE.md`](../ARCHITECTURE.md).
